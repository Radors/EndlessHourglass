...
{
    public class RedRangedProjectile : IActiveProjectile
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            spriteBatch.Draw(
                texture: _texture,
                position: Position,
                sourceRectangle: TextureStore.RedRangedProjectileRectangles[Math.Clamp(CurrentFrame - 1, 0, TotalFrames - 1)],
                color: Color.White,
                rotation: 0f,
                origin: default,
                scale: 1f,
